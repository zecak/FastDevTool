...
using GrpcCore.Client.DataManage.Pages;
...
namespace GrpcCore.Client.DataManage
{
        ...
        {
            {
                ...
                Helper.GrpcClientAgent.ClientType = "Client";
                Helper.GrpcClientAgent.UserName = "数据管理";
                    ...
                    if (resp.Code == 1)
                    {
                        ...
                        if (server != null)
                        {
                            ...
                            else
                            {
                                ...
                                Helper.GrpcClientClient.ClientType = "Client";
                                Helper.GrpcClientClient.UserName = "数据管理";
                                var task2 = Task.Factory.StartNew(() =>
                                {
                                    while (!task2TokenSource.Token.IsCancellationRequested)
                                    {
                                        ...
                                        {
                                            {
                                                var req2 = new APIRequest() { ApiPath = ActionApiPath.ServerOline, AppID = "数据管理", Time = DateTime.Now.ToTimestamp() };
                                            ...
                                            {
                                                var req2 = new APIRequest() { ApiPath = ActionApiPath.GetClients, AppID = "数据管理", Time = DateTime.Now.ToTimestamp() };
                                                req2.Sign = (req2.AppID + req2.Data + req2.Time + Helper.Agent.Key).ToMd5();
                                                var resp2 = Helper.GrpcClientClient.Exec(req2);
                                                if (resp2 == null)
                                                {
